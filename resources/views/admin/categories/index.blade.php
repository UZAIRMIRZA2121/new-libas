        ...
        <tbody>
            @forelse($categories as $category)
                <tr style="cursor: pointer; background: #fff;" onclick="toggleSubcategories({{ $category->id }})">
                    ...
                    <td>
                        <label class="switch" onclick="event.stopPropagation()">
                            <input type="checkbox" onchange="toggleStatus({{ $category->id }}, this)" {{ $category->is_active ? 'checked' : '' }}>
                ...
                <tr class="subcategory-{{ $category->id }}" style="display: none; background: #f8fafc;">
                    ...
                    <td>
                        <label class="switch" onclick="event.stopPropagation()">
                            <input type="checkbox" onchange="toggleStatus({{ $child->id }}, this)" {{ $child->is_active ? 'checked' : '' }}>
                            <span class="slider round"></span>
                        </label>
                    </td>
                    <td>
